...
import SVGExperienceDesign from "../assets/experience_design.svg"
...
const IndexPage = () => (
  <Layout>
    ...
    <Home>
      ...
      <Link className="my-3 border-b-2 hover:border-indigo-500" to="/licencia/">
        Licencia de uso
      </Link>
      <ImgContainer>
        <SVGExperienceDesign />
...
const Home = styled.div`
  ${tw`flex flex-col items-center justify-end pt-6 text-center bg-gray-100 border-b border-indigo-300 shadow-sm`}
  min-height: 50vh;
